    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td class="text-center">
                <form action="<?php echo e(route('brng.destroy',$barang->kd_barang)); ?>" method="POST">

                   <a class="btn btn-info btn-sm" href="<?php echo e(route('brng.show',$barang->kd_barang)); ?>">Show</a>

                    <a class="btn btn-primary btn-sm" href="<?php echo e(route('brng.edit',$barang->kd_barang)); ?>">Edit</a>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4\htdocs\qword\resources\views/brng/index.blade.php ENDPATH**/ ?>